...
async function main() {
    ...
    // Transactions
    const genTx = (days, type, amount, categoryId, accountId, comment, subcategoryId) => ({
        id: (0, uuid_1.v4)(),
        type,
        amount,
        categoryId,
    ...
    // Goals
    const goal1Id = (0, uuid_1.v4)();
    const goal2Id = (0, uuid_1.v4)();
    const goal3Id = (0, uuid_1.v4)();
    ...
    await prisma.goalContribution.createMany({
        data: [
            { id: (0, uuid_1.v4)(), goalId: goal1Id, amount: 20000, date: subMonths(today, 2) },
            { id: (0, uuid_1.v4)(), goalId: goal1Id, amount: 25000, date: subMonths(today, 1) },
            { id: (0, uuid_1.v4)(), goalId: goal2Id, amount: 100000, date: subMonths(today, 6) },
            { id: (0, uuid_1.v4)(), goalId: goal2Id, amount: 100000, date: subMonths(today, 3) },
            { id: (0, uuid_1.v4)(), goalId: goal3Id, amount: 50000, date: subMonths(today, 1) },
            { id: (0, uuid_1.v4)(), goalId: goal3Id, amount: 30000, date: subDays(today, 15) },
        ],
    });
